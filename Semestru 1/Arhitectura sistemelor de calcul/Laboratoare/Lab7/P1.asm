...
segment code use32 class=code
    start:
        ...
        ; Se da un sir de quadworduri. Sa se identifice octetii inferiori din cuvintele superioare din dublu cuvintele inferioare. 
        ; Dupa ce s-au identificat octetii sa se verifice daca au suma cifrelor egale cu o constanta k definita in data segment iar in caz afirmativ sa se salveze acesti octeti 
        ; intr-un sir rezultat dupa ce au fost inmultiti cu valoarea constantei k.
