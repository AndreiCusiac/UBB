...
segment code use32 class=code
    start:
        ...
        ParcurgeS:
            ...
            lodsb ; al = elementul curent din s
            ...
            Culegem:
                mov al, byte[k] ; pregatim incarcarea valorii contorului in d
                stosb ; ii asignam pozitiei actuale din d numarul cifrelor de 1 din reprezentarea binara a octetului corespunzator din s
