...
def test_verif_cond_lista():
    ...
    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 1, 1, 4)
    assert d == [4]

    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 1, 1, 2)
    assert d == []

    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 2, 1, 30)
    assert d == [1]

    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 2, 0, 40)
    assert d == [0, 1, 5]

    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 0, 0, 50)
    assert d == [0, 1, 2, 3, 4, 5]

    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 0, 2, 50)
    assert d == []

    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 1, 0, 6)
    assert d == [0, 1, 2, 3, 4, 5]

def test_sum_tot():
    assert (sum_tot([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], [1, 2, 3]) == 135)
    assert (sum_tot([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], []) == 0)
    assert (sum_tot([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], [6]) == 0)
    assert (sum_tot([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], [1]) == 30)

def test_index_sum_max():
    assert (index_sum_max([]) == -1)
    assert (index_sum_max([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,70]]) == 5)
    assert (index_sum_max([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,60]]) == 3)
...
def tip_zi_sum(c):
    ...
    verif_cond_lista(c, d, 2, 0, s)
    verif_cond_lista(c, e, 0, 0, z)
...
def test_elim_tip():
    ...
    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 1, 1, 5)
    assert d == [1]
    ...
    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 1, 1, 3)
    assert d == [0, 3, 5]
...
def test_elim_sum():
    ...
    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 2, 0, 20)
    assert d == []

    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 2, 0, 30)
    assert d == [0, 5]
    ...
    d.clear()
    verif_cond_lista([[2,3,20], [4,5,30], [1,1,45], [2,3,60], [16,4,50], [20,3,26]], d, 2, 0, 50)
    assert d == [0, 1, 2, 5]
