...
public class Rezervare implements Serializable {
    ...
    public Rezervare(String cnp, String name, LocalDate date, Integer treatment_location, Integer type, String treatment_date, Integer treatment_hour_start, Integer treatment_minute_start, Integer treatment_hour_end, Integer treatment_minute_end) {
        this.cnp = cnp;
        this.name = name;
        this.date = date;
