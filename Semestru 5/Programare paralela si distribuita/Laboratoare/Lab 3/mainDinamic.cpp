...
void calculateMatrixByThreads(int **f, int **w, int **v, int matrix_rows, int matrix_columns, int window_rows, int window_columns, int iStart, int jStart, int pas) {
    int row_shift = window_rows/2, column_shift = window_columns/2;
    int current_overlap_row, current_overlap_column;
    int sum, prod;
...
void calculateThreads(int **f, int **w, int **v, int matrix_rows, int matrix_columns, int window_rows, int window_columns) {
