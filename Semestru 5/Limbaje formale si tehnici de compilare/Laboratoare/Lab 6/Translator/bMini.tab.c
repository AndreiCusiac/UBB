...
/* In a future release of Bison, this section will be replaced
   by #include "bMini.tab.h".  */
#ifndef YY_YY_BMINI_TAB_H_INCLUDED
# define YY_YY_BMINI_TAB_H_INCLUDED
/* Enabling traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_BMINI_TAB_H_INCLUDED  */

/* Copy the second part of user declarations.  */

/* Line 390 of yacc.c  */
#line 301 "bMini.tab.c"
...
{
      18,     0,    -1,    19,     4,    -1,    19,    20,    -1,    20,
      -1,    21,     9,    -1,    24,     9,    -1,    22,     9,    -1,
      23,     9,    -1,     3,    15,    -1,     6,     8,    15,    -1,
       5,     7,    15,    -1,    -1,    15,    10,    25,    26,    -1,
      33,    -1,    27,    11,    28,    -1,    27,    12,    29,    -1,
      27,    13,    30,    -1,    31,    14,    32,    -1,    16,    -1,
      15,    -1,    16,    -1,    15,    -1,    16,    -1,    15,    -1,
      16,    -1,    15,    -1,    16,    -1,    15,    -1,    16,    -1,
      15,    -1,    16,    -1,    15,    -1
};
...
{
       0,   172,   172,   179,   180,   183,   184,   185,   186,   189,
     202,   218,   239,   239,   249,   251,   253,   255,   257,   260,
     263,   268,   274,   282,   288,   296,   305,   316,   322,   330,
     342,   353,   360
};
#endif
...
{
  "$end", "error", "$undefined", "INT", "RETURN", "COUT", "CIN", "OUTP",
  "INP", "SEMICOLON", "EQUAL", "PLUS", "MINUS", "MULTIPLY", "DIVIDE", "ID",
  "CONST", "$accept", "program", "statement_list", "statement", "decl",
  "read_statement", "write_statement", "assignment", "$@1", "expression",
  "op", "opAd", "opMin", "opMul", "opDeimp", "opImp", "term", YY_NULL
};
#endif
...
{
       0,     0,     0,     0,     0,     0,     0,     4,     0,     0,
       0,     0,     9,     0,     0,    12,     1,     2,     3,     5,
       7,     8,     6,    11,    10,     0,    20,    19,    13,     0,
       0,    14,     0,     0,     0,     0,    22,    21,    15,    24,
      23,    16,    26,    25,    17,    30,    29,    18
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     5,     6,     7,     8,     9,    10,    11,    25,    28,
      29,    38,    41,    44,    30,    47,    31
};
...
{
       1,    -6,     4,    22,    21,    14,    -3,    -7,    23,    24,
      25,    26,    -7,     0,    27,    -7,    -7,    -7,    -7,    -7,
      -7,    -7,    -7,    -7,    -7,     5,    -4,    -1,    -7,     6,
      29,    -7,     7,     9,    11,    13,    -7,    -7,    -7,    -7,
      -7,    -7,    -7,    -7,    -7,    -7,    -7,    -7
};
...
{
       1,    17,     2,     3,     1,   -32,     2,     3,   -31,    12,
     -28,    13,     4,   -27,    16,    23,     4,    32,    33,    34,
      26,    27,    36,    37,    39,    40,    42,    43,    45,    46,
      14,    15,    19,    20,    21,    22,    18,     0,     0,     0,
       0,     0,    24,    35
};
...
{
       3,     4,     5,     6,     3,     9,     5,     6,     9,    15,
      14,     7,    15,    14,     0,    15,    15,    11,    12,    13,
      15,    16,    15,    16,    15,    16,    15,    16,    15,    16,
       8,    10,     9,     9,     9,     9,     6,    -1,    -1,    -1,
      -1,    -1,    15,    14
};
...
{
       0,     3,     5,     6,    15,    18,    19,    20,    21,    22,
      23,    24,    15,     7,     8,    10,     0,     4,    20,     9,
       9,     9,     9,    15,    15,    25,    15,    16,    26,    27,
      31,    33,    11,    12,    13,    14,    15,    16,    28,    15,
      16,    29,    15,    16,    30,    15,    16,    32
};
...
#line 189 "bMini.y"
    { /*strcpy($$.cod,"");*/
				...
				int added = addId((yyvsp[(2) - (2)].varname));
				
				if (added == 1) {
					addID2DataSegmentBuffer((yyvsp[(2) - (2)].varname));
				}
              }
    break;
...
/* Line 1792 of yacc.c  */
#line 202 "bMini.y"
    { sprintf(tempbuffer,"push dword %s", (yyvsp[(3) - (3)].varname));
...
/* Line 1792 of yacc.c  */
#line 218 "bMini.y"
    { sprintf(tempbuffer,"mov eax, [%s]", (yyvsp[(3) - (3)].varname));
								addCode2CodeSegmentBuffer(tempbuffer);
...
#line 239 "bMini.y"
    {
					...
					sprintf(idToAssign, "%s", (yyvsp[(1) - (2)].varname));
                   }
    break;
...
/* Line 1792 of yacc.c  */
#line 260 "bMini.y"
    { sprintf(tempbuffer,"mov eax, %s", (yyvsp[(1) - (1)].varname));
			addCode2CodeSegmentBuffer(tempbuffer);	  
			}
    break;
...
/* Line 1792 of yacc.c  */
#line 268 "bMini.y"
    { sprintf(tempbuffer,"add eax, %s", (yyvsp[(1) - (1)].varname));
			addCode2CodeSegmentBuffer(tempbuffer);
...
/* Line 1792 of yacc.c  */
#line 282 "bMini.y"
    { sprintf(tempbuffer,"sub eax, %s", (yyvsp[(1) - (1)].varname));
			addCode2CodeSegmentBuffer(tempbuffer);
...
/* Line 1792 of yacc.c  */
#line 296 "bMini.y"
    { sprintf(tempbuffer,"mov ebx, %s", (yyvsp[(1) - (1)].varname));
			addCode2CodeSegmentBuffer(tempbuffer);
...
/* Line 1792 of yacc.c  */
#line 316 "bMini.y"
    { sprintf(tempbuffer,"mov ax, %s", (yyvsp[(1) - (1)].varname));
			addCode2CodeSegmentBuffer(tempbuffer);
			
			sprintf(tempbuffer,"mov dx, 0", (yyvsp[(1) - (1)].varname));
			addCode2CodeSegmentBuffer(tempbuffer);
			}
    break;
...
/* Line 1792 of yacc.c  */
#line 322 "bMini.y"
    { sprintf(tempbuffer,"mov ax, word[%s + 0]", (yyvsp[(1) - (1)].varname));
			addCode2CodeSegmentBuffer(tempbuffer);
			
			sprintf(tempbuffer,"mov dx, word[%s + 2]", (yyvsp[(1) - (1)].varname));
			addCode2CodeSegmentBuffer(tempbuffer);
			}
    break;
...
/* Line 1792 of yacc.c  */
#line 330 "bMini.y"
    { sprintf(tempbuffer,"mov bx, %s", (yyvsp[(1) - (1)].varname));
			addCode2CodeSegmentBuffer(tempbuffer);
...
/* Line 1792 of yacc.c  */
#line 342 "bMini.y"
    { sprintf(tempbuffer,"div word[%s]", (yyvsp[(1) - (1)].varname));
			addCode2CodeSegmentBuffer(tempbuffer);
