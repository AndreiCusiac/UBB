...
public class EditMessageTaskController {
    ...
    private void saveMessage(MessageTask m)
    {
        ...
        try {
            ...
            if (r == null) {
                MessageAlert.showMessage(null, Alert.AlertType.INFORMATION, "Adaugare mesaj", "Mesaj adaugat cu succes!");
            }
            else {
                MessageAlert.showMessage(null, Alert.AlertType.ERROR, "ID existent", "ID-ul mesajului exista deja!");
            }
