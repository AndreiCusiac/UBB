...
public class UI {
    ...
    public void meniu() throws UserRepoValidator, FriendshipRepoValidator {
        String s = "";
    ...
    private void showFriendshipsOfUser() throws FriendshipRepoValidator, UserRepoValidator {
        ...
        for (var x : networkService.getFriendshipsOf(ID)) {
            if (x.getId1().equals(ID)) {
                System.out.println("Nume: " + x.getUser2().getLastName() + " | Prenume: " + x.getUser2().getFirstName() + " | Data: " + x.getDate());
            }
            else
            {
                System.out.println("Nume: " + x.getUser1().getLastName() + " | Prenume: " + x.getUser1().getFirstName() + " | Data: " + x.getDate());
    ...
    private void showRequests() throws FriendshipRepoValidator {
        System.out.println("\nAfisare cereri\n");
