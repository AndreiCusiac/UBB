...
//
//        try {
//            serverProps.load(StartProtoServer.class.getResourceAsStream("/chatserver.properties"));
...
//        IService serverApp = new ServerAppService(matchRepository, ticketBoothRepository, ticketRepositoryH);
//
...
//
//        AbstractServer server = new ProtobuffConcurrentServer(chatServerPort, serverApp);
//
//        try {
//            server.start();
//        } catch (Exception e) {
