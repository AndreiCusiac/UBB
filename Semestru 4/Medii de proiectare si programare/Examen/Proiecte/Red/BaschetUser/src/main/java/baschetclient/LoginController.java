...
//    }
    ...
    public void handleLogIn() throws Exception {
        ...
        try{
            if (service.isAuthValid(name, homeController) == true) {

                //player = service.getTicketBoothByName(name);

//                ticketBoothCurrent = new TicketBooth(name, password);
                currentStage.close();

                startApp(new Player(name));
            /*
...
//            ((Node)(actionEvent.getSource())).getScene().getWindow().hide();
            ...
            stage.show();*/
                ...
                MessageAlert.showErrorMessage(null, "Atentie!\nNumele și/ sau parola nu sunt valide!");
            }
        } catch (Exception e) {
    ...
    private void startApp(Player playerToLogIn) throws Exception {
        /*Stage stage = new Stage();
...
//        stage.setTitle(title);
        ...
        stage.setOnCloseRequest(new EventHandler<WindowEvent>() {
            ...
            public void handle(WindowEvent event) {
                try {
//                    homeController.handleLogOut();
                    service.logout(playerToLogIn, homeController);
                } catch (InterruptedException e) {
                    e.printStackTrace();
                } catch (IOException e) {
                    e.printStackTrace();
        ...
        homeController.setCurrentPlayer(playerToLogIn);
        homeController.initDisplay();
