...
public class StartRpcServer {
    ...
    public static void main(String[] args) {
        ...
        CardRepository cardRepository = new CardHbRepository(serverProps);

        WordRepository wordRepository = new WordHbRepository(serverProps);
...
//        IService serverApp = new ServerAppService(matchRepository, ticketBoothRepository, ticketRepository);
        IService serverApp = new ServerAppService(gameRepository, cardRepository, wordRepository, moveRepository, matchRepository, playerRepositoryH, ticketRepositoryH);
