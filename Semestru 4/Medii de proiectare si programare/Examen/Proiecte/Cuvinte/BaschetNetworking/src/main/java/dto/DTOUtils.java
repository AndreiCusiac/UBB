...
//    public static MoveDTO getMoveDTOFromPlayerAndCard(Player player, Card card) {
//        return new MoveDTO(player, card);
//    }

    public static Player getPlayerFromMoveDTO(MoveDTO moveDTO) {
        return moveDTO.getPlayer();
    }

    public static String getGuessFromMoveDTO(MoveDTO moveDTO) {
        return moveDTO.getGuess();
    }
    ...
    public static String getPunctajFromGuessDTO(GuessDTO guessDTO) {
        return guessDTO.getPunctaj();
    }

    public static GuessDTO getGuessDTOFromStrings (String guess, String punctaj) {
        return new GuessDTO(punctaj, guess);
    }
