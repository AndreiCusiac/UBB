...
public:
	...
	Doctor (const string& c, const string& n, const string& p, const string& s, const int& con) : cnp{c}, nume{n}, prenume{p}, sectie{s}, concediu{con}
	{
	...
	void set_concediu(const int& con);
};
